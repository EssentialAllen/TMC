...
export function Cta() { return <section className="cta"><div className="shell cta-inner"><div><Eyebrow>06 / START A PROJECT</Eyebrow><h2>Tell us what you’re building.</h2><p>Share the project, location, and timing. We’ll follow up with a clear next step.</p></div><Link href="/contact" className="button button-light">Start a Project <span aria-hidden>→</span></Link></div></section> }
